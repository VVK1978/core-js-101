...
function isLeapYear(date) {
  if (date.getFullYear() % 4 === 0 && date.getFullYear() !== 1900) return true;
  return false;
}
...
function timeSpanToString(startDate, endDate) {
  ...
  function addZerroMil(n) {
    return n < 10 ? '00' : '';
  }

  return (
    `${addZerro(endDate.getHours() - startDate.getHours())}`
    + `${endDate.getHours() - startDate.getHours()}`
    + ':'
    + `${addZerro(endDate.getMinutes() - startDate.getMinutes())}`
    + `${endDate.getMinutes() - startDate.getMinutes()}`
    + ':'
    + `${addZerro(endDate.getSeconds() - startDate.getSeconds())}`
    + `${endDate.getSeconds() - startDate.getSeconds()}`
    + '.'
    + `${addZerroMil(endDate.getMilliseconds() - startDate.getMilliseconds())}`
